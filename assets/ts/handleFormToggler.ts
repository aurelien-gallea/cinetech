...
const mailIcon = document.querySelector("#mailIcon") as HTMLElement;
const passIcon1 = document.querySelector("#passIcon1") as HTMLElement;
const passIcon2 = document.querySelector("#passIcon2") as HTMLElement;
const login1 = document.querySelector("#login1") as HTMLInputElement;
...
const errorLogin1 = document.querySelector("#errorLogin1") as HTMLElement;
const errorMail = document.querySelector("#errorMail") as HTMLElement;
const errorPass1 = document.querySelector("#errorPass1") as HTMLElement;
const errorPass2 = document.querySelector("#errorPass2") as HTMLElement;
...
const colorStatus = ( input: HTMLInputElement, iconColor: HTMLElement, errorMessage: HTMLElement ) : void => {
